...
```bash
# Summarize feedback from grades.csv (provider auto-resolved from model)
./utils/summarize_feedback.sh grades.csv --model gemini-2.5-pro

# Specify total marks if not 100
./utils/summarize_feedback.sh grades.csv --model claude-sonnet-4 --total-marks 50

# Specify custom output file
./utils/summarize_feedback.sh grades.csv --model gpt-5.1 --output summaries.csv
